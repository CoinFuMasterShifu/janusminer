...
#define CMDLINE_PARSER_PACKAGE "wart-miner-janushash"
#endif

#ifndef CMDLINE_PARSER_PACKAGE_NAME
/** @brief the complete program name (used for help and version) */
#define CMDLINE_PARSER_PACKAGE_NAME "wart-miner-janushash"
#endif
...
struct gengetopt_args_info
{
  ...
  int threads_arg;	/**< @brief Number of CPU worker threads, use 0 for hardware concurrency.  (default='0').  */
  char * threads_orig;	/**< @brief Number of CPU worker threads, use 0 for hardware concurrency.  original value given at command line.  */
  const char *threads_help; /**< @brief Number of CPU worker threads, use 0 for hardware concurrency.  help description.  */
